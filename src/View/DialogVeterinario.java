 ...
 * @author Personal
 */
public class DialogVeterinario extends javax.swing.JDialog {
    private VeterinarioDAO dao = new VeterinarioDAO();
    private SimpleDateFormat format = new SimpleDateFormat("dd/MM/yyyy");
    //carregar a table
    private void loadVeterinarioTable(){
        tableVeterinario.setModel(
        new MyTableModel(Veterinario.class, 
                         dao.getVeterinarioList(), 
                         tableVeterinario)
        );
    }        
    private void loadVeterinarioTable(String filtro){
        tableVeterinario.setModel(
        new MyTableModel(Veterinario.class, 
                         dao.getVeterinarioList(filtro), 
                         tableVeterinario)
        );    
    }
    private void loadVeterinarioTable(Cidade cidade){
        tableVeterinario.setModel(
        new MyTableModel(Veterinario.class, 
                         dao.getVeterinarioList(cidade), 
                         tableVeterinario)
        );        
    }
    ...
    private void loadCidadeList(){
        comboCidade.setModel(
                ...
                new Vector(new CidadeDAO().getAll())));
    }
    ...
    //cria objeto a partir de componentes
    private Veterinario createObject() throws ParseException{
        return new Veterinario(
                textId.getText().isEmpty()?0:Integer.parseInt(textId.getText()), 
                textNome.getText(), 
                textTelefone.getText(), 
                format.parse(textNascimento.getText()), 
                (Cidade)comboCidade.getSelectedItem());
    }
    //preenche os componentes com os valores do objeto
    private void fillComponents(Veterinario veterinario){
        textId.setText(veterinario.getId()+"");
        textNome.setText(veterinario.getNome());
        textTelefone.setText(veterinario.getTelefone());
        textNascimento.setText(format.format(veterinario.getNascimento()));
        comboCidade.setSelectedItem(veterinario.getCidade());        
    }
    /**
     * Creates new form DialogVeterinario
     */
    public DialogVeterinario(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        tableVeterinario.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tableVeterinarioMouseClicked(evt);
            }
        });
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addComponent(textTelefone, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 96, Short.MAX_VALUE)
    ...
    private void buttonSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonSalvarActionPerformed
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "ERRO de DATA");
    ...
    private void buttonRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonRemoverActionPerformed
        ...
        try{
            dao.remove(
            dao.get(Veterinario.class, Integer.parseInt(textId.getText())));
            this.iniciaComponentes();
            this.loadVeterinarioTable();
        }catch(Exception ex){
            JOptionPane.showMessageDialog(null, ex.getMessage());
    ...
    private void tableVeterinarioMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableVeterinarioMouseClicked
        // TODO add your handling code here:
        if (evt.getClickCount()==2){
            int codigo=
            Integer.parseInt(
            tableVeterinario.getValueAt(tableVeterinario.getSelectedRow(), 0)+"");
            Veterinario v = dao.get(Veterinario.class, codigo);
            this.fillComponents(v);
        }
    }//GEN-LAST:event_tableVeterinarioMouseClicked

    private void buttonFiltrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonFiltrarActionPerformed
        // TODO add your handling code here:
        this.loadVeterinarioTable(textFiltro.getText());
    ...
    private void buttonFiltrarCidadeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonFiltrarCidadeActionPerformed
        ...
        this.loadVeterinarioTable(cidade);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogVeterinario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogVeterinario dialog = new DialogVeterinario(new javax.swing.JFrame(), true);
